...
{ 
   ...
   if (newPtr != NULL)
     {           //got a buffer so add to the top of the stack
       newPtr->data = info;           
...
/*
 * Remember we discussed the implicit IF in 
 * the return statement above.
 *
 * We also discussed that functions that are
 * appropriately named make for readable code.
 *
 */
